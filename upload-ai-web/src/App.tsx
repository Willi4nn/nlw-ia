        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="treanscription_prompt">Prompt de transcrição</Label>
              <Textarea className="h-20 leading-relaxed resized-none" placeholder="Inclua palavras-chave mencionadas no vídeo separadas por vírgula (,)"
                id="treanscription_prompt"
              />
            </div>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <span className="block text-xs text-muted-foreground italic leading-relaxed">Valores mais altos tendem a deixar o resultado mais criativa e com possíveis erros.</span>
            </div>
